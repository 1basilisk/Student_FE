...
function Login() {
  ...
  return (
    <>
      <Header />
      <div className="max-w-md mx-auto p-8 shadow rounded-lg mt-12 bg-white dark:bg-gray-800 text-gray-900 dark:text-white">
        <h2 className="text-2xl font-bold text-center mb-6">Login</h2>

        {message && (
          <p className="text-center text-red-500 dark:text-red-400 mb-4">{message}</p>
        )}
